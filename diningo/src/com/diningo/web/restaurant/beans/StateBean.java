 ...
 *                                                                           *
 *****************************************************************************
 * $Id: StateBean.java,v 1.2 2008/01/22 22:02:51 manish Exp $
 *****************************************************************************
 */
...
StateBean {
    ...
    public StateBean(String jdbcDS) {
        ResultSet rs = null;
        ...
        try {
             ...
             sqlString = "select   a.state_tbl_pk "
                       +         ",a.state_name "
                       +  "from    state_tbl      a "
             ...
             states  = new State[rs_count];
            
             int i = 0;           
             while (rs.next()) {
                 states[i] = new State();
                 states[i].setState_tbl_pk(rs.getString(1));
                 states[i].setState_name(rs.getString(2));
