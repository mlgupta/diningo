 ...
 *                                                                           *
 *****************************************************************************
 * $Id: DinersCouponsForm.java,v 1.4 2007/05/09 21:19:16 manish Exp $
 *****************************************************************************
 */
...
/**
 *              Purpose: To store and display diner coupons information in diners_coupons.jsp
 *
 *             @author   Manish Gupta
 *            @version   1.0
...
DinersCouponsForm extends ValidatorForm {
    ...
    private RestaurantCouponsBean[] couponBean;
    ...
    public void setCouponBean(RestaurantCouponsBean[] couponBean) {
        this.couponBean = couponBean;
    }

    public RestaurantCouponsBean[] getCouponBean() {
        return couponBean;
    }
}
