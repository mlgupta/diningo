 ...
 *                                                                           *
 *****************************************************************************
 * $Id: RestaurantSubscriptionDeleteAction.java,v 1.2 2007/05/01 20:29:34 manish Exp $
 *****************************************************************************
 */
...
RestaurantSubscriptionDeleteAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, 
        ...
        try {
           ...
           rc = Operations.DeleteRestaurantSubscription(RestaurantSubscriptionForm,ds);
           if (rc < 0) {
                actionErrors.add("subscription",new ActionMessage("errors.subscription.delete.error"));
