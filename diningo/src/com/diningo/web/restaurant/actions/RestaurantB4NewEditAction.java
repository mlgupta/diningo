 ...
 *                                                                           *
 *****************************************************************************
 * $Id: RestaurantB4NewEditAction.java,v 1.4 2008/01/22 22:02:51 manish Exp $
 *****************************************************************************
 */
...
/**
 *              Purpose: To display restaurant specific information for creating or editing restaurant
 *
 *             @author   Manish Gupta
 *            @version   1.0
...
RestaurantB4NewEditAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, 
      ...
      try {
           ...
           String restaurantTblPk = request.getParameter("restaurant_tbl_pk");
           
           if (restaurantTblPk.equals("") || restaurantTblPk == null) {
             logger.debug("Passed parameter restaurant_tbl_pk is blank or null");
           }
           else {
               DBConnection dbcon = new DBConnection(ds);

               RestaurantListForm.setHdnRestaurantTblPk(restaurantTblPk);
               ...
               sqlString = "select   a.restaurant_tbl_pk "                            +
                           ...
                           "where   a.restaurant_tbl_pk   = " + restaurantTblPk;
               ...
               while (rs.next()) {
                   ...
                   RestaurantListForm.setTxtUserTblFk(rs.getString(10));
                   RestaurantListForm.setTxtAddress1(rs.getString(11));
                   RestaurantListForm.setTxtAddress2(rs.getString(12));
                   RestaurantListForm.setTxtCity(rs.getString(13));
                   RestaurantListForm.setTxtStateTblFk(rs.getString(14));
                   RestaurantListForm.setTxtZipcode(rs.getString(15));
               ...
               sqlString = "select   a.restaurant_contact_people_tbl_pk "             +
                                   ...
                                   ",a.email "                                        +
                                   ",a.phone "                                        +
                           "from    restaurant_contact_people_tbl a "                 +
                           "where   a.restaurant_tbl_fk   = " + restaurantTblPk;
