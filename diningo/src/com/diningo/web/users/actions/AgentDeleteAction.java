 ...
 *                                                                           *
 *****************************************************************************
 * $Id: AgentDeleteAction.java,v 1.5 2007/05/01 20:29:34 manish Exp $
 *****************************************************************************
 */
...
/**
 *              Purpose: To delete selected agent
 *
 *             @author   Manish Gupta
 *            @version   1.0
...
AgentDeleteAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, 
      ...
      try {
         ...
         rc = Operations.DeleteAgent(AgentForm,ds);
         if (rc < 0) {
